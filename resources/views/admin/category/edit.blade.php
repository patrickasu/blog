                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form method="POST" action="/admin/post-category/{{$category->id}}">
                                        @csrf 
                                        @method('PUT')
                                        <div class="form-group">
                                            <label for="inputname">Category Name</label>
                                            <input id="inputname" type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" name="name" value="{{ old('name', $category->name) }}" autocomplete="name" autofocus placeholder="Category name">
                                            @error('name')
